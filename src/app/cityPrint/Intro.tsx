    ...
    <div className=" mt-32 flex w-full items-center">
      <div className=" w-1/2 ">
        ...
        <div className="mt-20 flex flex-col gap-3 text-gray-600">
          ...
          <Label>
            you're looking to create custom apparel for your team, promote your
            brand, or express your personal style,
          </Label>
          <Label>
          ...
          <div className="  mt-8 flex w-full gap-8   ">
            ...
            <div
              className="  items flex cursor-pointer gap-4 rounded-md border-2 border-black bg-white px-20 py-2 shadow-sm drop-shadow-sm hover:bg-blue-50"
              onClick={() =>
                window.open("/cityPrint/promotional-video", "_blank")
              }
            >
